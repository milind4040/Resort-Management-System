  ...
  return (
    <Box sx={{ bgcolor: "#f8fafc", color: "#1f2937" }}>
      ...
      >
        ...
        <Toolbar sx={{ maxWidth: 1200, mx: "auto", width: "100%" }}>
          <Typography variant="h6" fontWeight={900} sx={{ flexGrow: 1 }}>
            <span style={{ color: "black" }}>Resort</span>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={4}>
              <Typography color="black" fontWeight={600}>ResortHub</Typography>
          ...
          <Box sx={{ textAlign: "center" }}>
            <Typography variant="caption">© 2026 ResortHub. All rights reserved By Milind❤️.</Typography>
          </Box>
        </Container>
      </Box>
    </Box>
